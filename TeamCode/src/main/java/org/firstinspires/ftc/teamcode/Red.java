...
public class Red extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Pose2d startRedOut = new Pose2d(102.0, 102.0, zero);
        Pose2d startRedIn = new Pose2d(102.0, 125.0, zero);
        Waypoint start = new StartWaypoint(startRedOut);

        Pose2d disks = new Pose2d(119, 113, zero);
        ...
        if (detection == 0) {
            square = new Pose2d(150, 90, zero); // Square A
        } else if (detection == 1) {
            //Pick up 1 disk
            square = new Pose2d(175, 113, zero); // Square B
        } else {
            //Pick up 3 disks
            square = new Pose2d(200, 90, zero); // Square C
        }
        ...
        Pose2d powerTarget = new Pose2d(160.0, 113.0, zero); //Location of power target shooting and parking
